...
public class TileRecycleFurnace extends TileEntity implements IInventory, ITickable {
    ...
    public static ItemStack getSmeltingResultForItem(ItemStack stack) { return RecipesInventoryFurnace.getInstance().getRecycleResult(stack); }
...
//	//  it uses getUpdatePacket(), getUpdateTag(), onDataPacket(), and handleUpdateTag() to do this
   ...
   */
    ...
    public String getName() {
        return "container.recycle_furnace.name";
    }
