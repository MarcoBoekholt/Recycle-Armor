...
public class GuiRecycleFurnace extends GuiContainer {

    // This is the resource location for the background image
    private static final ResourceLocation texture = new ResourceLocation("ra", "textures/gui/recycle_furnace_bg.png");
    private TileRecycleFurnace tileEntity;

    public GuiRecycleFurnace(InventoryPlayer invPlayer, TileRecycleFurnace tileRecycleFurnace) {
        super(new ContainerRecycleFurnace(invPlayer, tileRecycleFurnace));

        // Set the width and height of the gui
        xSize = 176;
        ySize = 179;

        this.tileEntity = tileRecycleFurnace;
    }

    // some [x,y] coordinates of graphical elements
    final int COOK_BAR_XPOS = 49;
    final int COOK_BAR_YPOS = 32;
    final int COOK_BAR_ICON_U = 0;   // texture position of white arrow icon
    final int COOK_BAR_ICON_V = 179;
    final int COOK_BAR_WIDTH = 80;
    final int COOK_BAR_HEIGHT = 17;

    final int FLAME_XPOS = 77;
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        final int LABEL_XPOS = this.xSize / 2 - this.fontRenderer.getStringWidth(this.tileEntity.getDisplayName().getUnformattedText()) / 2;
